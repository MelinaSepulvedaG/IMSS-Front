 ...
 */
@Component({
  selector: 'app-dieta-consult',
  templateUrl: './dieta-consult.component.html',
  styleUrls: ['./dieta-consult.component.css']
})
export class DietaConsultComponent {
  displayedColumns: string[] = ['nombre', 'codigoColor', 'clave', 'descripcion','aplicacion'];
  dataSource = ELEMENT_DATA;

  columnas = [
    {titulo: "Nombre",name: "nombre"},
    {titulo: "Codigo de color",name: "codigoColor"},
    {titulo: "Clave",name: "clave"},
    {titulo: "Descripcion",name: "descripcion"},
    {titulo: "Aplicacion",name: "aplicacion"},
  ];
}
